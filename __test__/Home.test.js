...
describe('<Home />', () => {
    ...
    describe('Shallow Render REACT COMPONENTS',()=>{
        ...
        it('contains input with placeholder ="Output"', () => {
            expect(wrapper.find('input[placeholder="Output"]').prop('value')).toEqual(output)
        });
        it('contains readOnly input with placeholder ="Output"', () => {
            expect(wrapper.find('input[readOnly]').type()).toEqual('input')
        });       
    ...
    //*******************************************************************************************************
    describe('REACT-REDUX (Mount + wrapping in <Provider>)',()=>{
    ...
    //*******************************************************************************************************
    describe('REACT-REDUX (actual Store + reducers) more of Integration Testing',()=>{
        const initialState = {output:10}
        let store,wrapper
